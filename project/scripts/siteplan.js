document.addEventListener("DOMContentLoaded", function() {
    // EXPANDED DEALERSHIP DATA with WORKING IMAGES
    const dealerships = [
        {
        ...
        },
        {
            ...
            location: "Orem, UT",
            image: "https://images.unsplash.com/photo-1568605117036-5fe5e7fa0ac7?w=400&h=250&fit=crop&auto=format",
        ...
        },
        {
            name: "Ford of Provo",
            location: "Provo, UT",
            image: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=400&h=250&fit=crop&auto=format",
            link: "https://www.fordofprovo.com"
        },
        {
            name: "Tesla - Salt Lake City",
            location: "Salt Lake City, UT",
            image: "https://images.unsplash.com/photo-1536700503339-1e4b0442073f?w=400&h=250&fit=crop&auto=format",
        ...
        },
        {
            ...
            location: "Salt Lake City, UT",
            image: "https://images.unsplash.com/photo-1544829099-b9c0a607dab9?w=400&h=250&fit=crop&auto=format",
        ...
        },
        {
            ...
            location: "Salt Lake City, UT",
            image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?w=400&h=250&fit=crop&auto=format",
            ...
            dealerships.forEach(dealer => {
                ...
                card.innerHTML = `
                    <img 
                        ...
                        src="${dealer.image}" 
                        alt="${dealer.name}"
                        onerror="this.src='https://placehold.co/400x250/1e3a8a/white?text=${encodeURIComponent(dealer.name)}'">
                    <h3>${dealer.name}</h3>
                    <p>📍 ${dealer.location}</p>
